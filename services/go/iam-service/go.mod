module github.com/agenthub/platform/iam-service

go 1.22.0

require (
	github.com/agenthub/platform/shared/crypto v0.0.0
...
replace github.com/agenthub/platform/shared/crypto => ../shared/crypto
