...
def init_db() -> None:
    with get_connection() as conn:
        conn.executescript(
            ...
            CREATE TABLE IF NOT EXISTS tasks(id TEXT PRIMARY KEY,session_id TEXT NOT NULL,status TEXT NOT NULL DEFAULT 'PENDING',dag_json TEXT NOT NULL,current_node_id TEXT,template_id INTEGER,created_at TEXT NOT NULL,updated_at TEXT NOT NULL);
...
def migrate_existing_schema(conn) -> None:
    migrations = {
        ...
        "tasks": ["ALTER TABLE tasks ADD COLUMN current_node_id TEXT", "ALTER TABLE tasks ADD COLUMN template_id INTEGER"],
