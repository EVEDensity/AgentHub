...
This slice does not yet resolve a tenant-scoped Agent catalog or execute the
child. Those remain scheduler/adapter work and are explicit follow-up stages.
