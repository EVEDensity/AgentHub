...
const MessageList = memo(function MessageList({
  ...
  return (
    <section ref={messagesContainerRef as React.LegacyRef<HTMLElement>} className="flex-1 overflow-auto px-4 md:px-6 lg:px-8 py-4 md:py-6 chat-scroll-container">
